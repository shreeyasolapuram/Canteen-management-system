...
<section class="heading">
    <h3>Your EatList </h3>
    <p> <a href="home.php">Home</a> / EatList </p>
</section>

<section class="wishlist">

    <h1 class="title">Food added</h1>
    ...
    $grand_total += $fetch_wishlist['price'];
        ...
        echo '<p class="empty">your eatlist is empty</p>';
    }
    ?>
    </div>
    ...
    <div class="wishlist-total">
        ...
        <a href="wishlist.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all from eatlist?');">delete all</a>
    </div>
